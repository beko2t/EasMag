...
if (isset($_SESSION['email'])) {
    ...
    (!isset($_SESSION['project']) & isset($_GET['project'])) ? $_SESSION['project'] = $_GET['project'] : false;
    
    
    if ( isset($_SESSION['project'])) {
        
        $_SESSION['project'] = ( $_GET['project'] !== $_SESSION['project'] ) ? $_SESSION['project'] = $_GET['project'] : $_SESSION['project'];
        
        echo '    <!-- Start issues page -->
        <div class="nav-part nav nav-tabs" id="nav-tab" role="tablist">
        <a class="text-decoration-none" href="?issue"><button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true"> '. lang('issue').'</button></a>
        ...
        $projectid = isset($_SESSION['project']) && is_numeric($_SESSION['project']) ?  intval($_SESSION['project']) : 0 ;
        
        $count = $querys -> checkDuplicate('project_id','project', $projectid);

        if($count > 0) { 
        // releases page start

        include $clas . 'issuesH.php';
